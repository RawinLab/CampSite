...
### Acceptance Criteria
- [ ] Inquiry form displays on campsite detail page
- [ ] Form fields: name, email, phone, inquiry type, message, dates (optional)
- [ ] Pre-filled fields for logged-in users
- [ ] Message length 20-2000 characters
- [ ] Phone validation for Thai format (optional field)
- [ ] Rate limiting: 5 inquiries per user per 24 hours
- [ ] Owner receives email notification within 1 minute
...
- [ ] T001 P1 US-018 Create inquiries table migration [agent: backend-architect] [deps: none] [files: supabase/migrations/20260117140000_create_inquiries.sql]
- [ ] T002 P1 US-018 Create inquiry status enum [agent: backend-architect] [deps: T001] [files: supabase/migrations/20260117140001_inquiry_status_enum.sql]
- [ ] T003 P1 US-018 Create inquiries RLS policies [agent: backend-architect] [deps: T001] [files: supabase/migrations/20260117140002_inquiries_rls_policies.sql]
- [ ] T004 P1 US-018 Create inquiry indexes for performance [agent: backend-architect] [deps: T001] [files: supabase/migrations/20260117140003_inquiry_indexes.sql]
...
- [ ] T006 P1 US-018 Create inquiry Zod schema [agent: backend-architect] [deps: none] [files: packages/shared/src/schemas/inquiry.ts]
- [ ] T007 P1 US-018 Create inquiry TypeScript interfaces [agent: backend-architect] [deps: none] [files: packages/shared/src/types/inquiry.ts]
- [ ] T008 P1 US-018 Add Thai phone regex validation [agent: backend-architect] [deps: T006] [files: packages/shared/src/schemas/inquiry.ts]
...
- [ ] T012 P1 US-018 Install express-rate-limit package [agent: backend-architect] [deps: none] [files: apps/campsite-backend/package.json]
- [ ] T013 P1 US-018 Create inquiry rate limit middleware [agent: backend-architect] [deps: T012] [files: apps/campsite-backend/src/middleware/inquiryRateLimit.ts]
- [ ] T014 P1 US-018 Configure rate limit storage [agent: backend-architect] [deps: T013] [files: apps/campsite-backend/src/middleware/inquiryRateLimit.ts]
...
- [ ] T018 P1 US-018 Install Mailgun SDK [agent: backend-architect] [deps: none] [files: apps/campsite-backend/package.json]
- [ ] T019 P1 US-018 Create email service module [agent: backend-architect] [deps: T018] [files: apps/campsite-backend/src/services/emailService.ts]
- [ ] T020 P1 US-018 Create inquiry notification email template [agent: backend-architect] [deps: T019] [files: apps/campsite-backend/src/templates/inquiry-notification.html]
- [ ] T021 P1 US-018 Create inquiry confirmation email template [agent: backend-architect] [deps: T019] [files: apps/campsite-backend/src/templates/inquiry-confirmation.html]
- [ ] T022 P1 US-018 Create inquiry reply email template [agent: backend-architect] [deps: T019] [files: apps/campsite-backend/src/templates/inquiry-reply.html]
...
- [ ] T026 P1 US-018 Create POST /api/inquiries endpoint [agent: backend-architect] [deps: T006] [files: apps/campsite-backend/src/routes/inquiries.ts]
- [ ] T027 P1 US-018 Implement inquiry controller [agent: backend-architect] [deps: T026] [files: apps/campsite-backend/src/controllers/inquiryController.ts]
- [ ] T028 P1 US-018 Apply rate limit middleware to inquiry endpoint [agent: backend-architect] [deps: T013, T026] [files: apps/campsite-backend/src/routes/inquiries.ts]
- [ ] T029 P1 US-018 Integrate email sending in controller [agent: backend-architect] [deps: T019, T027] [files: apps/campsite-backend/src/controllers/inquiryController.ts]
- [ ] T030 P1 US-018 Add analytics tracking for inquiries [agent: backend-architect] [deps: T027] [files: apps/campsite-backend/src/controllers/inquiryController.ts]
...
- [ ] T034 P1 US-018 Create InquiryForm component [agent: frontend-developer] [deps: T006] [files: apps/campsite-frontend/src/components/inquiry/InquiryForm.tsx]
- [ ] T035 P1 US-018 Create InquiryDialog component [agent: frontend-developer] [deps: T034] [files: apps/campsite-frontend/src/components/inquiry/InquiryDialog.tsx]
- [ ] T036 P1 US-018 Create InquiryConfirmation component [agent: frontend-developer] [deps: T034] [files: apps/campsite-frontend/src/components/inquiry/InquiryConfirmation.tsx]
- [ ] T037 P1 US-018 Create InquiryRateLimit component [agent: frontend-developer] [deps: T034] [files: apps/campsite-frontend/src/components/inquiry/InquiryRateLimit.tsx]
- [ ] T038 P1 US-018 Add character counter to message field [agent: frontend-developer] [deps: T034] [files: apps/campsite-frontend/src/components/inquiry/InquiryForm.tsx]
- [ ] T039 P1 US-018 Integrate inquiry form in campsite detail page [agent: frontend-developer] [deps: T034] [files: apps/campsite-frontend/src/app/campsites/[id]/page.tsx]
...
### Acceptance Criteria
- [ ] Booking button displays on campsite detail page
- [ ] Button opens external URL in new tab
- [ ] Click tracking event sent to analytics
- [ ] Phone number shown if no booking URL
- [ ] Phone link works on mobile devices
- [ ] Disabled state if no booking info available

### Tasks

#### Phase 1: Booking Button Component
- [ ] T049 P1 US-019 Create BookingButton component [agent: frontend-developer] [deps: none] [files: apps/campsite-frontend/src/components/campsite/BookingButton.tsx]
- [ ] T050 P1 US-019 Add analytics tracking on click [agent: frontend-developer] [deps: T049] [files: apps/campsite-frontend/src/components/campsite/BookingButton.tsx]
- [ ] T051 P1 US-019 Integrate BookingButton in detail page [agent: frontend-developer] [deps: T049] [files: apps/campsite-frontend/src/app/campsites/[id]/page.tsx]
...
- [ ] Database migrations applied (inquiries table, status enum, RLS, indexes)
- [ ] Rate limiting middleware implemented
- [ ] Email service integrated with Mailgun
- [ ] All API endpoints functional
- [ ] All frontend components created

### Functionality
- [ ] Inquiry form displays on campsite detail page
- [ ] Form fields: name, email, phone, inquiry type, message, check-in/out dates
- [ ] Pre-filled fields for logged-in users (name, email, phone)
- [ ] Message character counter (20-2000 chars)
- [ ] Phone validation for Thai format (0812345678)
- [ ] Date validation (checkout after checkin)
- [ ] Rate limiting: 5 inquiries per user per 24 hours
- [ ] 429 error shown on 6th request
- [ ] Owner receives email notification within 1 minute
- [ ] User receives confirmation email
- [ ] Success message displayed after submission
- [ ] Form clears after successful submission
- [ ] Booking button opens external URL in new tab
- [ ] Analytics tracking for booking clicks
- [ ] Phone link works on mobile
- [ ] Disabled state when no booking info
...
- [ ] RLS policies enforce owner-only access to inquiries

### Performance
- [ ] Inquiry submission completes within 2 seconds
- [ ] Email sent within 1 minute (non-blocking)
...
- [ ] No console errors during inquiry flow
...
- [ ] Environment variables documented (MAILGUN_API_KEY, MAILGUN_DOMAIN)

### Quality
- [ ] No ESLint errors
- [ ] No TypeScript errors
- [ ] Proper error handling for API failures
- [ ] Email failures logged but don't block submission
