...
import { signupSchema, type SignupInput } from '@campsite/shared';
  ...
  const onSubmit = async (data: SignupInput) => {
    ...
    if (error) {
      if (error.message.includes('already registered')) {
        setErrorMessage('อีเมลนี้ถูกใช้งานแล้ว กรุณาใช้อีเมลอื่นหรือเข้าสู่ระบบ');
      } else {
    ...
    setSuccessMessage('ลงทะเบียนสำเร็จ! กรุณาตรวจสอบอีเมลของคุณเพื่อยืนยันบัญชี');
    onSuccess?.();
  };
